...
- refactor: extract \_version.py from **init**.py (PR-3/8) (#2550)
...
- refactor: extract \_assets.py and \_utils.py from **init**.py (PR-2/8) (#2543)
- fix(opencode): use commands/ directory (plural) to match OpenCode docs (#2453)
- refactor: extract \_console.py from **init**.py (PR-1/8) (#2474)
