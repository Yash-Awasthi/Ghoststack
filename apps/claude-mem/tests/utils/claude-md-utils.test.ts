...
describe("updateFolderClaudeMdFiles", () => {
  ...
  it("should handle projectRoot with trailing slash correctly", async () => {
    ...
    await updateFolderClaudeMdFiles(["src/utils/file.ts"], "test-project", 37777, "/home/user/my-project/");
...
describe("path validation in updateFolderClaudeMdFiles", () => {
  it("should reject tilde paths", async () => {
    ...
    await updateFolderClaudeMdFiles(["~/.claude-mem/logs/worker.log"], "test-project", 37777, tempDir);
  ...
  it("should reject URLs", async () => {
    ...
    await updateFolderClaudeMdFiles(["https://example.com/file.ts"], "test-project", 37777, tempDir);
  ...
  it("should reject paths with spaces", async () => {
    ...
    await updateFolderClaudeMdFiles(["PR #610 on thedotmack/CLAUDE.md"], "test-project", 37777, tempDir);
  ...
  it("should reject paths with hash symbols", async () => {
    ...
    await updateFolderClaudeMdFiles(["issue#123/file.ts"], "test-project", 37777, tempDir);
  ...
  it("should reject path traversal outside project", async () => {
    ...
    await updateFolderClaudeMdFiles(["../../../etc/passwd"], "test-project", 37777, tempDir);
  ...
  it("should accept absolute paths within project root", async () => {
    ...
    await updateFolderClaudeMdFiles([absolutePathInProject], "test-project", 37777, tempDir);
  ...
  it("should accept valid relative paths", async () => {
    ...
    await updateFolderClaudeMdFiles(["src/utils/logger.ts"], "test-project", 37777, tempDir);
...
describe("issue #814 - reject consecutive duplicate path segments", () => {
  it("should reject paths with consecutive duplicate segments like frontend/frontend/", async () => {
    ...
    await updateFolderClaudeMdFiles(["frontend/src/file.ts"], "test-project", 37777, path.join(tempDir, "frontend"));
  ...
  it("should reject paths with consecutive duplicate segments like src/src/", async () => {
    ...
    await updateFolderClaudeMdFiles(["src/components/file.ts"], "test-project", 37777, path.join(tempDir, "src"));
  ...
  it("should allow paths with non-consecutive duplicate segments", async () => {
    ...
    await updateFolderClaudeMdFiles(["src/components/src/utils/file.ts"], "test-project", 37777, tempDir);
...
describe("issue #859 - skip folders with active CLAUDE.md", () => {
  it("should skip folder when CLAUDE.md was read in observation", async () => {
    ...
    await updateFolderClaudeMdFiles(["/project/src/utils/CLAUDE.md"], "test-project", 37777, "/project");
  ...
  it("should skip folder when CLAUDE.md was modified in observation", async () => {
    ...
    await updateFolderClaudeMdFiles(["/project/src/CLAUDE.md"], "test-project", 37777, "/project");
  ...
  it("should handle relative CLAUDE.md paths with projectRoot", async () => {
    ...
    await updateFolderClaudeMdFiles(["src/components/CLAUDE.md"], "test-project", 37777, "/project");
  ...
  it("should skip only the specific folder containing active CLAUDE.md", async () => {
    ...
    await updateFolderClaudeMdFiles(
      ["/project/src/a/CLAUDE.md", "/project/src/b/CLAUDE.md", "/project/src/c/file.ts"],
      "test-project",
      37777,
      "/project"
    );
  ...
  it("should still exclude project root even when CLAUDE.md filter would allow it", async () => {
    ...
    await updateFolderClaudeMdFiles([join(projectRoot, "file.ts")], "test-project", 37777, projectRoot);
...
describe("issue #912 - skip unsafe directories for CLAUDE.md generation", () => {
  it("should skip node_modules directories", async () => {
    ...
    await updateFolderClaudeMdFiles(["node_modules/lodash/index.js"], "test-project", 37777, tempDir);
  ...
  it("should skip .git directories", async () => {
    ...
    await updateFolderClaudeMdFiles([".git/refs/heads/main"], "test-project", 37777, tempDir);
  ...
  it("should skip Android res/ directories", async () => {
    ...
    await updateFolderClaudeMdFiles(["app/src/main/res/layout/activity_main.xml"], "test-project", 37777, tempDir);
  ...
  it("should skip build/ directories", async () => {
    ...
    await updateFolderClaudeMdFiles(["build/outputs/apk/debug/app-debug.apk"], "test-project", 37777, tempDir);
  ...
  it("should skip __pycache__/ directories", async () => {
    ...
    await updateFolderClaudeMdFiles(["src/__pycache__/module.cpython-311.pyc"], "test-project", 37777, tempDir);
  ...
  it("should allow safe directories like src/", async () => {
    ...
    await updateFolderClaudeMdFiles(["src/utils/file.ts"], "test-project", 37777, tempDir);
  ...
  it("should skip deeply nested unsafe directories", async () => {
    ...
    await updateFolderClaudeMdFiles(["packages/frontend/node_modules/react/index.js"], "test-project", 37777, tempDir);
...
describe("CLAUDE.local.md support", () => {
  ...
  it("should skip folder when CLAUDE.local.md was read in observation", async () => {
    ...
    await updateFolderClaudeMdFiles(["/project/src/utils/CLAUDE.local.md"], "test-project", 37777, "/project");
