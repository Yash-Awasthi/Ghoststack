...
describe("buildTimeline", () => {
  it("should combine observations and summaries into timeline", () => {
    const observations = [createTestObservation({ id: 1, created_at_epoch: 1000 })];
    const summaries = [createTestSummaryTimelineItem({ id: 1, displayEpoch: 2000 })];
  ...
  it("should handle empty observations array", () => {
    const summaries = [createTestSummaryTimelineItem({ id: 1, displayEpoch: 1000 })];
  ...
  it("should use displayEpoch for summary sorting, not created_at_epoch", () => {
    const observations = [createTestObservation({ id: 1, created_at_epoch: 2000 })];
    const summaries = [
