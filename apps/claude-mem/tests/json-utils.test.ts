...
describe("JSON Utils", () => {
  ...
  describe("readJsonSafe", () => {
    ...
    it("throws on corrupt JSON file to prevent data loss", () => {
      ...
      expect(() => readJsonSafe(filePath, { recovered: true })).toThrow(/Corrupt JSON file, refusing to overwrite/);
    });
    ...
    it("throws on empty file to prevent data loss", () => {
      ...
      expect(() => readJsonSafe(filePath, [])).toThrow(/Corrupt JSON file, refusing to overwrite/);
    });
