...
describe("HybridSearchStrategy", () => {
  ...
  describe("findByConcept", () => {
    ...
    it("should propagate Chroma error (fail-fast, no silent fallback)", async () => {
      ...
      await expect(strategy.findByConcept("test-concept", options)).rejects.toThrow("Chroma failed");
    });
  });
  ...
  describe("findByType", () => {
    ...
    it("should propagate Chroma error (fail-fast, no silent fallback)", async () => {
      ...
      await expect(strategy.findByType("bugfix", options)).rejects.toThrow("Chroma unavailable");
    });
  ...
  describe("findByFile", () => {
    ...
    it("should propagate Chroma error (fail-fast, no silent fallback)", async () => {
      ...
      await expect(strategy.findByFile("/path/to/file.ts", options)).rejects.toThrow("Chroma down");
    });
  });
