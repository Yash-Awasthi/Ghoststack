...
describe("Observations Module", () => {
  ...
  describe("storeObservation", () => {
    ...
    it("should respect overrideTimestampEpoch", () => {
      ...
      const result = storeObservation(db, memorySessionId, project, observation, 1, 0, pastTimestamp);
    ...
    it("should use current time when overrideTimestampEpoch not provided", () => {
      ...
      const result = storeObservation(db, memorySessionId, "project", createObservationInput());
