...
import { createSDKSession, getSessionById, updateMemorySessionId } from "../../src/services/sqlite/Sessions.js";
...
describe("Sessions Module", () => {
  ...
  describe("platform_source", () => {
    ...
    it("should reject explicit platform_source conflicts for the same session", () => {
      ...
      expect(() => createSDKSession(db, "session-platform-3", "project", "prompt", undefined, "claude")).toThrow(
