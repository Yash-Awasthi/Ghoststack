...
async function dispatchToWorker(input: NormalizedHookInput, platformSource: string): Promise<HookResult> {
  const result = await executeWithWorkerFallback<{ status?: string }>("/api/sessions/observations", "POST", {
