...
import { cleanStalePidFile, getPlatformTimeout, spawnDaemon, touchPidFile } from "./infrastructure/ProcessManager.js";
import { isPortInUse, waitForHealth, waitForReadiness } from "./infrastructure/HealthMonitor.js";
...
export async function ensureWorkerStarted(port: number, workerScriptPath: string): Promise<WorkerStartResult> {
  if (!workerScriptPath) {
