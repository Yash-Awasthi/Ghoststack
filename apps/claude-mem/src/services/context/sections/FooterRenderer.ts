...
export function renderPreviouslySection(priorMessages: PriorMessages, forHuman: boolean): string[] {
  if (forHuman) {
...
export function renderFooter(economics: TokenEconomics, config: ContextConfig, forHuman: boolean): string[] {
