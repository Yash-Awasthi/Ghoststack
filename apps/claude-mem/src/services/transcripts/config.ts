  ...
  events: [
    ...
    },
    {
      ...
      fields: {
        ...
        toolName: {
          coalesce: ["payload.name", "payload.type"]
        },
        toolInput: {
    ...
    },
    {
      ...
      fields: {
        ...
        toolInput: {
          coalesce: ["payload.command", "payload.input"]
        },
        toolResponse: {
          coalesce: ["payload.aggregated_output", "payload.output", "payload.stdout", "payload.stderr"]
        }
      }
    },
    {
