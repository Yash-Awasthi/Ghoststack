...
<Info>**Free Tier:** 1,500 requests per day with `gemini-2.5-flash-lite`. No credit card required.</Info>
...
<Tip>
  **Higher rate limits:** Enable billing on your Google Cloud project to unlock 4,000 RPM (vs 10 RPM without billing).
