...
function readInstallMarkerVersion(markerPath) {
  ...
  try {
    ...
    return marker && typeof marker === "object" && typeof marker.version === "string" ? marker.version : null;
  } catch {
    const legacyVersion = content.trim();
    return LEGACY_VERSION_MARKER_RE.test(legacyVersion) ? legacyVersion.replace(/^v/i, "") : null;
  }
}
