...
<Tip>Bearer Token authentication is only relevant for HTTP-based transports.</Tip>
...
<Tip>If you're using a string token, do not include the `Bearer` prefix. FastMCP will add it for you.</Tip>
