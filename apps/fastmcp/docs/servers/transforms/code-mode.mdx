...
<Warning>
  CodeMode is experimental. The core interface is stable, but the specific discovery tools and their parameters may
  evolve as we learn more about what works best in practice.
</Warning>
