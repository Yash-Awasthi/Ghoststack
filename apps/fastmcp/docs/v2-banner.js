  ...
  function addBanner() {
    ...
    if (isV2 && container) {
      if (!banner) {
        ...
        banner.id = "v2-banner";
        banner.innerHTML =
          'These are the docs for FastMCP 2.0. <a href="/getting-started/welcome" style="color: white; text-decoration: underline; font-weight: 700;">FastMCP 3.0</a> is now available.';
