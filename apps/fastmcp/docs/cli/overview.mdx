...
Most commands need to know _which server_ to talk to. You pass a "server spec" as the first argument, and FastMCP resolves the right transport automatically.
